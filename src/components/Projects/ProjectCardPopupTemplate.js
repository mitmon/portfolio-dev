...
function ProjectCardPopupTemplate(props) {

    const { cardImgURL, cardAltText, dialogTitle, dialogSubtitle, dialogContent, portalLink, stack, textPrimary, buttonColor, cardTitle, cardCategory, cardDesc } = props
    ...
    return (
        ...
        >
            ...
            <Button sx={{mr:1, backgroundColor:buttonColor}} onClick={handleClose} variant='contained'>
                Close
            </Button>
            </DialogActions>
        </Dialog>
...
export { ProjectCardPopupTemplate };